...
The rig can be run either directly from the Bpod Console, or using a custom [GUI](gui.qmd) that is tailored for researcher assistants to easily run specific FMON experiments.
