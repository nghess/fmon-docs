...
This page includes all code used in the fmon_task.m protocol, along with a graph describing the flow of the Bpod finite state machine. You may click a node in the the graph to be taken to the relevant code block.
